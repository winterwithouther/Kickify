# WEB103 Project 4 - *Kickify*

Submitted by: **Eman Gurung**

About this web app: **Kickify is a full-stack sneaker customization platform built with React and Express that enables users to create, view, update, and delete personalized sneaker designs. The application features a dynamic user interface for selecting design attributes such as color, material, and size, along with a RESTful API and database for persistent data storage.**
